...
/* ⚠️ `1명`·`1인` 은 **앞에 숫자가 없을 때만**이다 (2026-09-15) — `311명, 421,000천원` 의
   `311명` 이 `1명` 으로 읽혀 예산 총액 4억 2천만원이 1인당이 됐다(울산연구원 실측). */
var PERSON_RE = /(1\s*인\s*당|인\s*당|(?:^|[^\d,])1\s*인|(?:^|[^\d,])1\s*명|명\s*당|인\s*기준)/;
