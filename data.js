...
/* 🔴 서비스하는 학교를 **둘로 좁혔다** (2026-08-30 개발자 지시: "온보딩은 2개로 줄이고").
   수집·정식 등록이 이미 이 둘뿐이라, 목록만 넓게 두면 다른 학교 학생이 자기 학교를 골라
   놓고 **빈 화면**을 보게 된다. 고르게 하지 않는 것이 정직하다.
   ⚠️ 지우지 않고 여기 둔다 — 되돌릴 때 목록을 처음부터 다시 만들지 않게.
      늘릴 때는 `collector/schools.json` 의 `parked` 도 함께 되돌려야 한다(수집이 있어야 공고가 온다).
   ⚠️ 학교 칸은 자유 입력이라 **다른 학교를 적는 것을 막지는 않는다.** 대신 앱이
      "아직 연결 전"이라고 정직하게 알린다(app.js schoolServed). */
const UNIVERSITIES_PARKED = [
  '서울대학교', '연세대학교', '고려대학교', '서강대학교', '성균관대학교',
  '한양대학교', '중앙대학교', '이화여자대학교', '서울시립대학교', '건국대학교',
  '동국대학교', '홍익대학교', '숙명여자대학교', '국민대학교', '숭실대학교',
  '세종대학교', '단국대학교', '광운대학교', '명지대학교', '상명대학교',
  '가톨릭대학교', '아주대학교', '인하대학교', '가천대학교', '경기대학교',
  '한국항공대학교', '서울과학기술대학교', '한성대학교', '부산대학교', '경북대학교',
  '전남대학교', '전북대학교', '충남대학교', '충북대학교', '강원대학교',
  '제주대학교', '경상국립대학교', '부경대학교', 'KAIST', 'POSTECH',
  'UNIST', 'GIST', 'DGIST', '한동대학교', '울산대학교',
  '영남대학교', '계명대학교', '동아대학교', '조선대학교', '원광대학교',
  '순천향대학교', '한림대학교', '을지대학교', '한국방송통신대학교', '한국교원대학교',
  '한국전통문화대학교', '한국에너지공과대학교(KENTECH)', '국립한국교통대학교', '서울교육대학교', '경인교육대학교',
  '공주교육대학교', '광주교육대학교', '대구교육대학교', '부산교육대학교', '전주교육대학교',
  '진주교육대학교', '청주교육대학교', '춘천교육대학교', '대한민국의 대학 목록', '가야대학교',
  '가톨릭관동대학교', '가톨릭꽃동네대학교', '감리교신학대학교', '강남대학교', '강서대학교',
  '건양대학교', '경남대학교', '경동대학교', '경성대학교', '경운대학교',
  '경일대학교', '경찰대학', '고신대학교', '광신대학교', '광주가톨릭대학교',
  '광주대학교', '광주여자대학교', '국립경국대학교', '국립공주대학교', '국립군산대학교',
  '국립금오공과대학교', '국립목포대학교', '국립목포해양대학교', '국립순천대학교', '국립창원대학교',
  '국립한국해양대학교', '국립한밭대학교', '극동대학교', '금강대학교', '김천대학교',
  '나사렛대학교', '나주대학교', '남부대학교', '남서울대학교', '대구가톨릭대학교',
  '대구대학교', '대구예술대학교', '대구한의대학교', '대신대학교', '대전가톨릭대학교',
  '대전대학교', '대전신학대학교', '대진대학교', '덕성여자대학교', '동덕여자대학교',
  '동명대학교', '동서대학교', '동신대학교', '동아방송예술대학교', '동양대학교',
  '동의대학교', '두원공과대학교', '루터대학교', '목원대학교', '목포가톨릭대학교',
  '배재대학교', '백석대학교', '부산가톨릭대학교', '부산외국어대학교', '부산장신대학교',
  '삼육대학교', '상지대학교', '서경대학교', '서울기독대학교', '서울신학대학교',
  '서울여자대학교', '서울장신대학교', '서울한영대학교', '서원대학교', '서일대학교',
  '선문대학교', '성결대학교', '성공회대학교', '성신여자대학교', '세명대학교',
  '세한대학교', '송원대학교', '수원가톨릭대학교', '수원대학교', '신경주대학교',
  '신라대학교', '신한대학교', '아신대학교', '안양대학교', '영남신학대학교',
  '영산대학교', '영산선학대학교', '예수대학교', '예원예술대학교', '용인대학교',
  '우석대학교', '우송대학교', '웅지세무대학교', '위덕대학교', '유원대학교',
  '인제대학교', '인천가톨릭대학교', '인천대학교', '장로회신학대학교', '전주대학교',
  '제주국제대학교', '제주한라대학교', '중부대학교', '중앙승가대학교', '중원대학교',
  '차의과학대학교', '창신대학교', '청운대학교', '청주대학교', '초당대학교',
  '총신대학교', '추계예술대학교', '칼빈대학교', '평택대학교', '한경국립대학교',
  '한국공학대학교', '한국기술교육대학교', '한국성서대학교', '한국체육대학교', '한국침례신학대학교',
  '한남대학교', '한라대학교', '한서대학교', '한세대학교', '한신대학교',
  '한일장신대학교', '협성대학교', '호남대학교', '호남신학대학교', '호서대학교',
  '호원대학교', '화성의과학대학교', '한국예술종합학교', '서울예술대학교', '연세대학교 미래캠퍼스',
  '고려대학교 세종캠퍼스', '한양대학교 ERICA캠퍼스', '건국대학교 글로컬캠퍼스', '동국대학교 WISE캠퍼스', '홍익대학교 세종캠퍼스',
  '상명대학교 천안캠퍼스',
];
...
/* 시·군·구 (2026-08-30 신설 — 개발자 지시).
   지역 장학금은 대부분 시·군 단위라 시·도만으로는 판정이 안 된다: 한국장학재단 등록
   116곳 중 **83곳(72%)** 이 지역 요건을 갖고 있고, 그 문장은 `안양시에 주소를 두고`·
   `무안군에 1년 이상` 처럼 시·군을 말한다.
   🔴 이 표는 **온보딩 화면에만** 쓴다. 판정(parse-requirements·match-engine)은 글자만
      견주므로 표가 필요 없다 — 서비스워커는 data.js 를 안 읽으므로 여기에 판정을 두면
      화면과 알림이 갈라진다(이 저장소가 되풀이해 겪은 사고).
   ⚠️ 세종은 단층 자치시라 하위가 없다. 대구 군위군은 2023-07 경북에서 편입됐다. */
/* ⚠️ **가나다순**으로 둔다 (2026-08-30 개발자 지시: "경기도면 과천시가 먼저지").
   행정 순서(수원·성남·고양…)는 목록에서 찾기 어렵다. 정렬은 여기 한 번만 해 두고
   화면은 그대로 쓴다 — 그릴 때마다 정렬하면 브라우저마다 순서가 갈릴 수 있다. */
const REGION_CITIES = {
