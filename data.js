...
const NATIONAL_SCHOLARSHIPS = [
  {
    ...
    duplicable: true,
    note: '실존하는 상시 제도. 정확한 신청 기간·지원 금액은 한국장학재단 공지에서 확인하세요.',
    program: true,
    sourceUrl: KOSAF_URL,
  },
  {
  ...
  },
  {
    ...
    duplicable: true,
    note: '시급·근로 한도는 매년 변경. 한국장학재단 공지에서 확인하세요.',
    program: true,
    sourceUrl: KOSAF_URL,
  },
  {
...
NATIONAL_SCHOLARSHIPS.push({
  ...
  summary: '대학생 멘토가 초·중·고 청소년에게 AI 활용 교육을 제공하고 장학금을 받는 실제 모집 공고입니다. 활동계획서 양식을 앱에서 그대로 작성 가능.',
...
const SUBMIT_GUIDES = {
  kosaf: [
    ...
    '통합신청 기간에 로그인(본인 인증)하고 신청서 작성',
    '가구원 정보제공 동의 진행 (부모님 인증 필요)',
    '이 앱에서 준비한 내용은 [복사] 버튼으로 붙여넣기',
  ],
  foundation: [
    '재단 공고에서 접수 방법(이메일·온라인 접수·우편) 확인',
    '이메일 접수라면 [파일과 함께 공유]로 서류를 일괄 전송',
    '온라인 접수라면 [복사] 버튼으로 작성한 내용 붙여넣기',
  ],
  campus: [
    '학교 포털 장학 메뉴 또는 장학팀 공지에서 접수 방법 확인',
    '이메일 접수라면 [파일과 함께 공유]로 서류를 일괄 전송',
    '포털 입력형이라면 [복사] 버튼으로 내용 붙여넣기',
  ],
};
