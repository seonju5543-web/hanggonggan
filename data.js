...
/* 분교 → 본교. 분교는 법적으로 별개 대학이라 학교 자체를 나눴지만,
   게시판을 본교와 함께 쓰는 곳이 있다(한양·건국·홍익 — 수집된 공고에 캠퍼스 표시가 없다).
   그 '캠퍼스 구분이 없는' 공고만 분교 학생에게도 보여 준다. 본교 캠퍼스가 찍힌 공고
   (연세 신촌·고려 안암·동국 서울)는 본교 것이므로 분교 학생에게 보이지 않는다. */
const BRANCH_OF = {
  '연세대학교 미래캠퍼스': '연세대학교',
  '고려대학교 세종캠퍼스': '고려대학교',
