...
**`bottom-nav`** — 4탭(홈 · 장학금 · 신청내역 · MY). 반투명 바탕(canvas 82%) + 위 1px hairline · 높이 73px + 안전 영역. 아이콘 23px 선 1.8 + `{typography.meta}`. 선택 `bottom-nav-selected` = `{colors.accent}` 글자 + 위 짧은 선(18×2 · 19번). 🔴 이 앱의 **눌린 탭이 강조색을 쓰는 유일한 자리 중 하나**다 — 전에는 먹색이라 안 눌린 것과 굵기로만 갈렸다.
...
| 나머지 | 유지 | 1·2·3·4·5·6·8·9·10·11·14·15·17 은 건드리지 않았다(개발자 지시) |
...
| 18 | eyebrow(작은 글자 + 양수 자간) | 20px 800 제목 | **2026-09-11 적용** — 크기만 내리고 양수 자간은 안 준다. 마감 구획은 먹색 | 적용됨 |
